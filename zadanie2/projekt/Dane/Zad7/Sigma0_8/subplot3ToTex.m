...
outputFile = '../../../../doc/projekt/figure/zad7liczSigma0_8.tex';
 outputFile = '../../../doc/projekt/figure/zad7nie_liczSigma0_8.tex';
% outputFile = '../../../doc/projekt/figure/zad6.tex';

u = dlmread('zad7_u_best_licz_zakl_sigma0_8.csv','\t');
y = dlmread('zad7_y_best_licz_zakl_sigma0_8.csv','\t');
%y_zad = dlmread('zad6_y_zad_best_nie_licz_zakl.csv','\t');
z = dlmread('zad7_z_best_licz_zakl_sigma0_8.csv','\t');
u = dlmread('zad7_u_best_nie_licz_zakl_sigma0_8.csv','\t');
y = dlmread('zad7_y_best_nie_licz_zakl_sigma0_8.csv','\t');
%y_zad = dlmread('zad6_y_zad_best_nie_licz_zakl.csv','\t');
z = dlmread('zad7_z_best_nie_licz_zakl_sigma0_8.csv','\t');

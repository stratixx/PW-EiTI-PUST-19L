...
% dlmwrite("../Dane/Zad6/DMC/DMC_best/y1.csv", y1, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/y2.csv", y2, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/y3.csv", y3, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/u1.csv", u1, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/u2.csv", u2, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/u3.csv", u3, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/u4.csv", u4, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/y1_zad.csv", y1_zad, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/y2_zad.csv", y2_zad, '\t');
% dlmwrite("../Dane/Zad6/DMC/DMC_best/y3_zad.csv", y3_zad, '\t');
...
outputFile = '../Wykresy_tex/proj_zadanie2u4.tex';

y1 = dlmread('zad2_y1_u4.csv','\t');
y2 = dlmread('zad2_y2_u4.csv','\t');
y3 = dlmread('zad2_y3_u4.csv','\t');
...
ylabel('S^1^,^4');
xlabel('k');
legend('S^1^,^4', 'Location', 'NorthEast');
grid on;
ylim([0 4]);
...
ylabel('S^2^,^4');
xlabel('k');
legend('S^2^,^4', 'Location', 'NorthEast');
grid on;
ylim([0 4]);
...
ylabel('S^3^,^4');
xlabel('k');
legend('S^3^,^4', 'Location', 'NorthEast');
grid on;
ylim([0 4]);
%box on;
